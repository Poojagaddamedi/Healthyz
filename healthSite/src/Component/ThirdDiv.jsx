      ...
      <Row className="align-items-center third-div-row">
        <Col md={9} className="position-relative third-div-col">
          <div className="position-relative third-div-content-wrapper">
            ...
            <div className="about-section third-div-about" data-aos="fade-up" data-aos-delay="200">
              ...
              <Button className="know-more-btn third-div-button">Know More</Button>
            </div>

            <div className="doctor-container position-absolute third-div-doctor">
              <img
