...
const MainServicesPage = () => {
  ...
  // Calendly script commented out per requirement
  // useEffect(() => {
  ...
  const services = [
    ...
    { title: "Pregnancy & Lactation Nutrition", description: "Ensure a safe pregnancy and postnatal recovery through expert nutrition diets. Our diets during pregnancy target fetal development, craving management, and prevention of deficiencies. We create lactation-friendly meal plans for new mothers to increase milk supply and recovery after giving birth. We ensure mother and baby receive all necessary nutrients for optimal health. Have a worry-free, health-promoting path to motherhood.", image: fruit2 },
